...
* Support for multiple indicator types: `none`, `underline`, `gradient`, `rounded`, `dot`, `bubble`, `rectangle`,
  `topLine`, `customPainter`, `custom`.
* Tab animation models: `TabAnimationModel` with configurable animation types, scale, colors, padding, curves, and
  wrappers.
