...
import 'package:reusable_tab_bar/views/widgets/indicators/styles/custom_painter_decoration.dart';
  ...
  static Decoration create(IndicatorModel indicator) {
    switch (indicator.type) {
      ...
      case IndicatorType.customPainter:
        if (indicator.customPainter == null) {
          throw ArgumentError('customPainter must be provided');
        }
        return CustomPainterDecoration(indicator.customPainter!);
